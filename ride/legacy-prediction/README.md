...
- `%s__eventAdminList` (`String`: `3N8xY1SPSrts3MSVQZRZPEc8JuuDYhALRCG__3Mps7CZqB9nUbEirYyCMMoA7VbqrxLvJFSB`) - Event admin list. Admin can set event status, edit info.

## Group keys

```txt
Key: %s%s%d__group__name__{groupId}
Value type: String
Key: %s%s%d__group__description__{groupId}
Value type: String
Key: %s%s%d__group__imgSrc__{groupId}
Value type: String
Key: %s%s%d__group__creator__{groupId}
Value type: String
Key: %s%s%d__group__source__{groupId}
Value type: String
Key: %s%s%d__group__events__{groupId}
Value type: String
```
...
```txt
Key: %s%s%d__event__name__{eventId}
Value type: String
Key: %s%s%d__event__status__{eventId}
Value type: Integer
Key: %s%s%d__event__groupId__{eventId}
Value type: String
Key: %s%s%d__event__description__{eventId}
Value type: String
Key: %s%s%d__event__endDatetime__{eventId}
Value type: Integer
Key: %s%s%d__event__creator__{eventId}
Value type: String
Key: %s%s%d__event__yesAssetId__{eventId}
Value type: String
Key: %s%s%d__event__noAssetId__{eventId}
Value type: String
Key: %s%s%d__event__tokensMinted__{eventId}
Value type: Integer
```
